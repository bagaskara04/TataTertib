...
<head>
    ...
    <title>Upload Bukti Kompen - Dashboard Mahasiswa</title>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="buktiKompen.php"><i class="fa fa-book"></i> <span>Upload Bukti Kompen</span></a></li>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Upload Bukti Kompen</h1>
        </section>

        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Upload Bukti Kompen</h3>
                </div>
                <div class="box-body" style="background-color: #ffffff;">
                    <form action="submitBuktiKompen.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="fileBukti">Pilih File Bukti Kompen</label>
                            <input type="file" class="form-control" id="fileBukti" name="fileBukti" required>
                        </div>
                        <div class="form-group">
                            <label for="description">Deskripsi Bukti Kompen</label>
                            <textarea class="form-control" id="description" name="description" rows="4" placeholder="Tulis deskripsi bukti kompen" required></textarea>
                        </div>
